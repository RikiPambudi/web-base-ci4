...
<header>
    ...
    <div class="heroe">
        ...
        <div class="max-w-lg bg-white p-6 rounded-2xl shadow-lg text-center">
        <img src="https://cdn.rri.co.id/berita/Bandung/o/1710769013217-IMG_6804/jdga1i4jp82kk9o.jpeg" class="w-32 h-32 mx-auto rounded-full border-4 border-blue-500">
        <h1 class="text-2xl font-bold text-gray-800 mt-4"><?= esc(data: $name) ?></h1>
        <p class="text-gray-600 mt-2"><?= esc(data: $job) ?></p>
        <p class="mt-4 text-gray-700"><?= esc(data: $detail) ?></p>

        <p class="mt-4 text-gray-700"><?= esc(data: $programming_skill) ?></p>
        <p class="mt-4 text-gray-700"><?= esc(data: $database_skill) ?></p>
        <div class="flex justify-center mt-4 space-x-4">
            <a href="https://id.linkedin.com/in/irsprs" class="text-blue-500 hover:text-blue-700">LinkedIn</a>
            <a href="https://github.com/RikiPambudi" class="text-blue-500 hover:text-blue-700">GitHub</a>
        </div>
    </div>
