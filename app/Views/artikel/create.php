        ...
        <div class="grid grid-cols-1 gap-6">
            ...
            <div>
                ...
                <textarea id="isi" name="isi" rows="10"
                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 p-2 border"><?= old('isi') ?></textarea>
            </div>
            ...
            <div>
                ...
                <select id="status" name="status"
                    ...
                    <option value="publish" <?= old('status') === 'publish' || !old('status') ? 'selected' : '' ?>>Publish
                    </option>
                </select>
            </div>
            ...
            <div>
                ...
                <textarea id="meta_deskripsi" name="meta_deskripsi" rows="3"
                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 p-2 border"><?= old('meta_deskripsi') ?></textarea>
