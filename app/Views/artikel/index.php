...
<div class="bg-white p-6 rounded-lg shadow-md">
    <div class="flex justify-between items-center mb-6">
        ...
        <a href="/artikel/create" class="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded">
    ...
    <form method="get" action="/artikel" class="mb-6 bg-gray-50 p-4 rounded-lg">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div class="flex items-end">
                ...
                <a href="/artikel" class="ml-2 bg-gray-500 hover:bg-gray-600 text-white px-4 py-2 rounded h-10 flex items-center">
                ...
                <tr>
                    ...
                    <td class="px-6 py-4 whitespace-nowrap">
                        <div class="flex items-center space-x-2">
                            <!-- Detail Button -->
                            <a href="/artikel/detail/<?= urlencode($item['slug']) ?>" 
                            ...
                            <!-- Status Dropdown -->
                            <form action="/artikel/<?= $item['id'] ?>/status" method="post" class="inline">
                                <?= csrf_field() ?>
                                <div class="relative">
                            ...
                            <!-- Delete Button -->
                            <form action="/artikel/<?= $item['id'] ?>" method="post" class="inline">
                                <?= csrf_field() ?>
